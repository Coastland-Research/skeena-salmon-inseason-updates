...
tyee.day<-as.Date("2024-06-25")
tyee.date<-"June 25"
fence.day<-as.Date("2024-06-25")
fence.date<-"June 25"
```
...
-   To date 23,813 sockeye are estimated to have passed by Tyee, with about 2.0% of the run through to date on average (0.6% if 1-week late, 5.2% if one week early).

-   It is too early to use the run timing to predict a final 2024 return of sockeye, however it is encouraging to see sockeye coming through already, however there was no catch of any species on June 25.
