...
tyee.day<-as.Date("2024-07-03")
tyee.date<-"July 3"
fence.day<-as.Date("2024-07-03")
fence.date<-"July 3"
```
...
-   To date 86,494 sockeye are estimated to have passed by Tyee, with about 5.9% of the run through to date on average (2.5% if 1-week late, 14.4% if one week early).
