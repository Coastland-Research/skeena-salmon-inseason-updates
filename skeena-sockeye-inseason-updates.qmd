...
```{r tyee model figure,fig.height=4,echo=FALSE,warning=FALSE,fig.cap="Forecasted final TRTC of Skeena sockeye based on the simple scalar run-timing model. The dashed horizontal show the median p50 value of the pre-season forecast (black), and the 90% confidence intervals (grey)."}
