...
tyee.day<-as.Date("2024-06-21")
tyee.date<-"June 21"
fence.day<-as.Date("2024-06-21")
fence.date<-"June 21"
```
...
-   To date 18,702 sockeye are estimated to have passed by Tyee, with about 1% of the run through to date.
...
-   If sockeye return at the pre-season forecasted abundance, a small commercial fishery will be able to be prosecuted (both marine and demo)
...
```{r,include=FALSE,fig.height=8,echo=FALSE,warning=FALSE,fig.cap="Cumulative estimated daily proportion of TRTC based on 1985-2021 average."}
i<-match(tyee.day,data$Date)
