...
tyee.day<-as.Date("2024-07-26")
tyee.date<-"July 26"
fence.day<-as.Date("2024-07-25")
fence.date<-"July 25"
...
-   Tyee Test Fishery
    ...
    -   To date 1,165,520 sockeye are estimated to have passed by Tyee, with about 55% of the run through to date on average (35% if 1-week late, 74% if one week early). While sockeye escapement over the last week picked up considerably, we are right at the peak of the run on average run-timing, and there are good tides for sockeye migration (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate around 1.2M (not including marine food fish and catch from the last few days).

    -   We are at the midpoint of the run on average timing, and gaining more confidence in predicting the final TRTC. The excel model increased in early July stabilized briefly, decreased significantly, and stabilized again, and slightly increased with the last 3-4 days of large runs, and is now decreasing again. We are now tracking slightly greater than the 2023 run.

    -   The current run size prediction is 2.2M on average run-timing (3.2M if one week late and 1.7M if 1 week early) (Figure 6). The next week will be important towards the peak of the run on average run timing, and will tell if we are tracking a 2022, 2023 or a something in between run. We should be seeing daily runs of aroudn 50-100k to keep pace with the 2023 return.

-   Babine Sockeye

    -   The Babine River fence started operations on July 9th. To July 25 the total run is 75,441 large sockeye, with 2,765 jack sockeye to date. More details will be added here shortly along with 2 forecast methods.
