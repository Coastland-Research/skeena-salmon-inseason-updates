...
tyee.day<-as.Date("2024-08-18")
tyee.date<-"August 18"
fence.day<-as.Date("2024-08-18")
fence.date<-"August 18"
today<-as.Date("2024-08-18")
```
...
-   Tyee Test Fishery
    ...
    -   To date \~1.69M sockeye are estimated to have passed by Tyee, with about 93% of the run through to date on average (88% if 1-week late, 97.5% if one week early). Daily sockeye counts have dropped and are now between 2-5,000 (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate is around 1.9M with about 200,000 marine commercial catch between Area C, Area A and First Nations Demo/EO fisheries.
    ...
    -   The Steelhead index suggests a strong run is continuing, around the 90th percentile. The latest Province of BC update estimates around 29,000 Steelhead through Tyee to date (as of August 8th) (Figure 11).
