...
tyee.day<-as.Date("2024-08-09")
tyee.date<-"August 9"
fence.day<-as.Date("2024-08-09")
fence.date<-"August 9"
today<-as.Date("2024-08-09")
```
...
-   Tyee Test Fishery
    ...
    -   To date \\\~ 1.65M sockeye are estimated to have passed by Tyee, with about 87% of the run through to date on average (74% if 1-week late, 93% if one week early). Daily sockeye counts are around 30,000 but declining and we are now well past the peak of the run (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate is around 1.85M.
    ...
    -   Chum salmon are starting to pass through Tyee and are currently showing a low index value near the 25th percentile.

    -   Pink salmon are looking strong this year relative to even-year abundance tracking around the 90th percentile.

    -   Coho salmon are passing through Tyee and tracking very close to the long term average.

    -   The Steelhead index suggests a strong run is continuing, around the 90th percentile. The latest Province of BC update estimates around 25,000 Steelhead through Tyee to date.

-   Babine Fence

    -   The Babine River fence started operations on July 9th. The total large sockeye run to date is \~ 498,000 with recent large return days bumping the run over the recent and historical averages, and exceeding 2023 (Figures 7-9).

    -   The total run of jack sockeye to date is now over 31,000, well above the longer term and recent averages (Figures 10-11).
