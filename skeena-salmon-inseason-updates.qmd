...
tyee.day<-as.Date("2025-08-10")
tyee.date<-"August 10"
figures.x.date<-as.Date("2025-09-01")

fence.day<-as.Date("2025-08-10")
fence.date<-"August 10"

today<-as.Date("2025-08-11")
```
...
-   Tyee Test Fishery
    ...
    -   If average run-timing, \~ 88% of the run has passed Tyee to date.
