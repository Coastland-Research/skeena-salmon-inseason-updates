...
tyee.day<-as.Date("2024-08-14")
tyee.date<-"August 14"
fence.day<-as.Date("2024-08-14")
fence.date<-"August 14"
today<-as.Date("2024-08-14")
```
...
-   Tyee Test Fishery
    ...
    -   Tides influence the migration of salmon into the Skeena River. We are currently at small tides moving towards larger tides. [(Tides section)](#tide-information-at-port-edward)

    -   To date \~1.69M sockeye are estimated to have passed by Tyee, with about 91% of the run through to date on average (84% if 1-week late, 96% if one week early). Daily sockeye counts have dropped and are now under 10,000 (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate is around 1.9M with about 200,000 marine commercial catch between Area C, Area A and First Nations Demo/EO fisheries.
    ...
    -   The current run size prediction is 2.0M on average run-timing (2.2M if one week late and 1.9M if 1 week early) (Figure 6). These should not change much anymore through the remainder of the run.
    ...
    -   Coho salmon are passing through Tyee and tracking very close to the long term average (Figure 10).

    -   The Steelhead index suggests a strong run is continuing, around the 90th percentile. The latest Province of BC update estimates around 25,000 Steelhead through Tyee to date (as of August 8th) (Figure 11).

-   Babine Fence

    -   The Babine River fence started operations on July 9th. The total large sockeye run to date is \~ 918k with recent large return days bumping the run over the recent and historical averages, and exceeding 2023 (Figures 12-14).

    -   The total run of jack sockeye to date is now over 54k, well above the longer term and recent averages (Figures 15-16).

-   Babine versus Tyee comparison

    -   Figure 17 shows the expected difference between the escapement past Tyee and the number of sockeye showing up at the Babine fence. This includes the in-river catch (to be updated shortly) and an adjustment assuming that 10% of the sockeye passing Tyee are non-Babine.

    -   Although the comparison showed some delay in migration at the start of the run, there is nothing concerning at this point with the Babine fence tracking the expected run at 3 weeks migration timing quite closely.
