...
tyee.day<-as.Date("2024-07-28")
tyee.date<-"July 28"
fence.day<-as.Date("2024-07-28")
fence.date<-"July 28"
today<-as.Date("2024-07-28")
```
...
-   Tyee Test Fishery
    ...
    -   To date 1,257,773 sockeye are estimated to have passed by Tyee, with about 61% of the run through to date on average (40% if 1-week late, 78% if one week early). While sockeye escapement over the last week picked up considerably, we are right at the peak of the run on average run-timing, and there are good tides for sockeye migration. Sockeye migration has dropped off over the last couple of days (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate around 1.3M (not including marine food fish and catch from the last few days).

    -   We are likely just past the midpoint of the run now, and gaining more confidence in predicting the final TRTC. The excel model increased in early July stabilized briefly, decreased significantly, and stabilized again, and slightly increased with the last 3-4 days of large runs, and is now decreasing again. We are now tracking slightly greater than the 2023 run.

    -   The current run size prediction is 2.1M on average run-timing (3M if one week late and 1.7M if 1 week early) (Figure 6). The next week will be important towards the peak of the run on average run timing, and will tell if we are tracking a 2022, 2023 or a something in between run. We should be seeing daily runs of around 50-100k to keep pace with the 2023 return.

-   Babine Sockeye

    -   The Babine River fence started operations on July 9th. To July 25 the total run is 125,878 large sockeye, with 6,175 jack sockeye to date. More details will be added here shortly along with 2 forecast methods.
...
-   Commercial Fisheries
    ...
    -   Commercial fishing has started, with an Area C gillnet openings on July 13, 20 and 21, and First Nations demonstration fisheries on July 16. Preliminary sockeye catch in the Area C gillnet openings is \~ 37,000. Preliminary demonstration fishery catches are \~ 2,000 sockeye. More catch information will be added as it becomes available.
