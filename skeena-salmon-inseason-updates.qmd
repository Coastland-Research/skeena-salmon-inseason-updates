...
-   Tyee Test Fishery
    ...
    -   Sockeye escapement estimates are tracking just below the median of returns from 1970-2024, with the TRTC model estimate stabilising over the last 2 weeks while decreasing slightly to around 1.63M on average timing (1.66M if one week late, and 1.62M if one week early), but still well below the pre-season forecast for early and average run-timing projections.
    -   If average run-timing, \~ 99% of the run has passed Tyee to date.
...
[Update to September 2](/data/steelhead/Skeena Summer Steelhead Update to Sept 2_25.xlsx)
...
[2025 Kitwanga River Salmon Enumeration Update #6](/data/KSEF_Update_6_September 3_2025.pdf)
...
[Update #8-September 2](/data/nc_stad_weekly_updates/NCA Weekly Update #9 Sept 2 2025.pdf)
