...
#| message: false
#| warning: false
#| fig-cap: "Daily run for Chinook salmon through Tyee (uncorrected) from 1970-2023. 2023 run is shown in purple."
#| fig-height: 5

daily<-read_csv("data/tyee_indices_to2023_chinook.csv")

gg.daily<-daily%>%
  mutate_if(is.character, as.numeric) %>%
  pivot_longer("1956":"2023",names_to="Year",values_to="Chinook") %>%
  mutate(Year=as.numeric(Year),
         Date = as.Date((paste(MONTH,DAY,Year,sep= "-")), "%Y-%m-%d"))
...
this plot needs to be re-worked with cumulative proportion data and re-format the dates, which are not showing up properly. Same for all the other species.
...
dailycum<-read_csv("data/tyee_indices_to2023_chinook.csv")

gg.daily.pcum<-dailycum%>%select("Date":"2023")%>%
  mutate_if(is.character, as.numeric) %>%
  pivot_longer("1970":"2023",names_to="Year",values_to="Chinook")%>%
  mutate(Year=as.numeric(Year))
...
ggplot(gg.daily.pcum,aes(x=Date,y=Chinook,group=Date))+
  geom_boxplot(fill="white",color="grey70",alpha=.5)+
    geom_line(data=data2,aes(x=as.POSIXct(date),y=p,color=estimate,group=estimate),linewidth=1,linewidth=1)+
...
#| message: false
#| warning: false
#| fig-cap: "Daily run for Chum salmon through Tyee (uncorrected) from 1970-2023. 2023 run is shown in purple."
#| fig-height: 5

daily<-read_csv("data/tyee_indices_to2023_chum.csv")
...
#| message: false
#| warning: false
#| fig-cap: "Daily run for Pink salmon (even years) through Tyee (uncorrected) from 1970-2022. 2022 run is shown in purple."
#| fig-height: 5

daily<-read_csv("data/tyee_indices_to2022_pink_even.csv")
...
#| message: false
#| warning: false
#| fig-cap: "Daily run for Pink salmon (odd years) through Tyee (uncorrected) from 1957-2023. 2023 run is shown in purple."
#| fig-height: 5

daily<-read_csv("data/tyee_indices_to2023_pink_odd.csv")
...
#| message: false
#| warning: false
#| fig-cap: "Daily run for Coho salmon through Tyee (uncorrected) from 1957-2023. 2023 run is shown in purple."
#| fig-height: 5

daily<-read_csv("data/tyee_indices_to2023_coho.csv")
