...
tyee.day<-as.Date("2025-08-03")
tyee.date<-"August 3"
figures.x.date<-as.Date("2025-09-01")

fence.day<-as.Date("2025-08-03")
fence.date<-"August 3"
...
make.tyee.sockeye.escapement.plots(250000,2000000,figures.x.date)
...
make.index.figures(daily,current,15,400,figures.x.date)
```
