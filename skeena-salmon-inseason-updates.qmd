...
tyee.day<-as.Date("2024-07-04")
tyee.date<-"July 4"
fence.day<-as.Date("2024-07-04")
fence.date<-"July 4"
```
...
-   To date 99,180 sockeye are estimated to have passed by Tyee, with about 6.8% of the run through to date on average (2.7% if 1-week late, 16.1% if one week early).

-   It is still too early to use the run timing to predict a final 2024 return of sockeye, however the 2024 return is tracking similar to 2021, below average, but with a bump up to larger daily runs over the long weekend and over the last couple of days (Figures 1-4).
