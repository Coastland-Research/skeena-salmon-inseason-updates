...
tyee.day<-as.Date("2024-08-05")
tyee.date<-"August 5"
fence.day<-as.Date("2024-08-05")
fence.date<-"August 5"
today<-as.Date("2024-08-05")
```
...
-   Tyee Test Fishery
    ...
    -   To date 1,519,685 sockeye are estimated to have passed by Tyee, with about 80% of the run through to date on average (64% if 1-week late, 90% if one week early). Daily sockeye counts are around 30,000 but declining and we are now well past the peak of the run (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate around 1.7M (not including marine food fish and catch from the last few days).

    -   The excel model increased in early July, stabilized briefly, decreased significantly, and stabilized again and has since been declining slowly. The 3 lines are coverging as is normal this time of year and this also supports average timing of the run. A late push of fish could change that however.

    -   The current run size prediction is 2.05M on average run-timing (2.5M if one week late and 1.8M if 1 week early) (Figure 6).

-   Babine Sockeye

    -   The Babine River fence started operations on July 9th. The total large sockeye run to date is 267,942, tracking the 2000-23 and 2020-23 averages failry closely, and tracking 2023 (Figures 7-9).
    -   The total run of jack sockeye to date is 16,544, above the longer term and recent averages (Figures 10-11).
