...
-   Tyee Test Fishery
    ...
    -   Sockeye escapement estimates are tracking right around the median of returns from 1970-2024, with the TRTC model estimate decreasing over the last few days to around 1.7M on average timing (3.7M if onbe week late, and 872k if one week early), and still well below the pre-season forecast for early and average run-timing projections.
    ...
    -   Chum and steelhead have been caught at Tyee, however supporting information indicates that some coho have been caught in FSC fisheries.
    -   To date no coho have been caught at Tyee.
...
p2<-make.recent.cum.plot(sx.cumesc,as.Date("2025-08-01"),500000)
