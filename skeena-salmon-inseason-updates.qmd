...
tyee.day<-as.Date("2025-07-31")
tyee.date<-"July 31"
figures.x.date<-as.Date("2025-08-15")

fence.day<-as.Date("2025-07-31")
fence.date<-"July 31"

today<-as.Date("2025-08-01")
```
...
-   Tyee Test Fishery
    ...
    -   Sockeye escapement estimates are tracking very close to the median of returns from 1970-2024, with the TRTC model estimate stabilising over the last 2 weeks while decreasing slightly to around 1.7M on average timing (2.5M if one week late, and 1.5M if one week early), but still well below the pre-season forecast for early and average run-timing projections.
    -   If average run-timing, ~ 64% of the run has passed Tyee to date.
    ...
    -   Pink salmon were tracking off the charts well above the highest run index ever. Supporting information from Area 3 and other fisheries indicates a very large pink return this year.
