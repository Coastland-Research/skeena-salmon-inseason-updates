...
tyee.day<-as.Date("2024-08-07")
tyee.date<-"August 7"
fence.day<-as.Date("2024-08-07")
fence.date<-"August 7"
today<-as.Date("2024-08-07")
```
...
-   Tyee Test Fishery
    ...
    -   To date 1,589,213 sockeye are estimated to have passed by Tyee, with about 84% of the run through to date on average (69% if 1-week late, 92% if one week early). Daily sockeye counts are around 30,000 but declining and we are now well past the peak of the run (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate is around 1.8M.

    -   The excel model increased in early July, stabilized briefly, decreased significantly, and stabilized again, declined slowly, and since has stabilized again. The 3 lines are coverging as is normal this time of year and this also supports average timing of the run. A late push of fish could change that however.

    -   The current run size prediction is 2.1M on average run-timing (2.5M if one week late and 1.9M if 1 week early) (Figure 6).
    ...
    -   Pink salmon are looking strong this year relative to even-year abundance with a high cumulative index.

    -   Coho salmon are passing through Tyee and tracking very close to the long term average.

    -   The Steelhead index suggests a strong run is continuing, around the 90th percentile.

-   Babine Fence

    -   The Babine River fence started operations on July 9th. The total large sockeye run to date is 355,082, tracking the 2000-23 and 2020-23 averages fairly closely, and tracking 2023 (Figures 7-9).
    
    -   The total run of jack sockeye to date is 23,371, above the longer term and recent averages (Figures 10-11).
    
    -   Other species figures are now updated for the Babine fence.
