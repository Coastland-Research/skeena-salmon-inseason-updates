...
tyee.day<-as.Date("2025-07-26")
tyee.date<-"July 26"
figures.x.date<-as.Date("2025-08-15")

fence.day<-as.Date("2025-07-26")
fence.date<-"July 26"

today<-as.Date("2025-07-27")
```
...
make.babine.figures("Large Sockeye",babine.figures.x.high,50000,200000)
...
make.babine.figures("Jack Sockeye",babine.figures.x.high,1000,25000)
```
