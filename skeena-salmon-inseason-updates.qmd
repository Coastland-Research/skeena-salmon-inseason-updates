...
-   Tyee Test Fishery
    ...
    -   To date 823,926 sockeye are estimated to have passed by Tyee, with about 43.2% of the run through to date on average (24% if 1-week late, 64% if one week early). Sockeye escapement is not picking up for a large run and is continuing to be variable (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate around 850,000 (not including marine food fish and catch from the last few days).
    ...
    -   The current run size prediction is 2.0M on average run-timing (3.2M if one week late and 1.4M if 1 week early) (Figure 6). The next week will be important towards the peak of the run on avearge run timing, and will tell if we are tracking a 2022, 2023 or a something in between run. We should be seeing daily runs of between 30,000 and 60,000 to keep pace with the 2023 return.
