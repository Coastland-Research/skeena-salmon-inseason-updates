...
tyee.day<-as.Date("2024-08-16")
tyee.date<-"August 16"
fence.day<-as.Date("2024-08-16")
fence.date<-"August 16"
today<-as.Date("2024-08-16")
```
...
ty<-read_excel("data/tyee and catch and fence in-season updates 2024.xlsx",sheet="Tyee") %>%
  mutate(Date = as.Date(Date))%>%
...
inrivercatch<-read_excel("data/tyee FN catch 2024.xlsx",sheet="inriver catch") # update this to 2024
...
demo.data<-read_excel("data/tyee FN catch 2024.xlsx",sheet="demo catches")
...
othercatch<-read_excel("data/tyee and catch and fence in-season updates 2024.xlsx",sheet="gncatch")
