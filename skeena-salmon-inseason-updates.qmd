...
tyee.day<-as.Date("2025-08-07")
tyee.date<-"August 7"
figures.x.date<-as.Date("2025-09-01")

fence.day<-as.Date("2025-08-07")
fence.date<-"August 7"

today<-as.Date("2025-08-08")
```
...
-   Tyee Test Fishery
    ...
    -   Moving towards smaller tides which may improve fish movement.
    -   Sockeye escapement estimates are tracking just below the median of returns from 1970-2024, with the TRTC model estimate stabilising over the last 2 weeks while decreasing slightly to around 1.7M on average timing (2.25M if one week late, and 1.5M if one week early), but still well below the pre-season forecast for early and average run-timing projections.
    -   If average run-timing, \~ 84% of the run has passed Tyee to date.
    ...
    -   Chum, steelhead, and coho have started showing up at Tyee, with indices remaining near average to date.
...
-   Commercial Fisheries
    ...
    -   Commercial fisheries targetting sockeye in Area 4 started on July 12 with 4 gillnet openings to date, and 1 seine opening.
...
<a class="btn btn-primary btn-sm steelhead-download" href="`r rmarkdown::metadata$steelhead$pdf`" target="_blank"> <i class="fa-solid fa-file-arrow-down"></i> Download steelhead update </a>
...
make.babine.figures("Large Sockeye",babine.figures.x.high,100000,500000)
...
make.babine.figures("Jack Sockeye",babine.figures.x.high,5000,50000)
```
...
make.babine.figures("Large Chinook",babine.figures.x.high,100,5000)
...
make.babine.figures("Jack Chinook",babine.figures.x.high,100,500)
...
make.babine.figures("Pink",babine.figures.x.high,10000,50000)
...
make.babine.figures("Coho",babine.figures.x.high,100,500)
...
[2025 Kitwanga River Salmon Enumeration Update #2](/data/kitwanga/KSEF_Update_August 5.pdf)
...
[Update #5-July 29](/data/nc_stad_weekly_updates/NCA-Weekly-Update-5-August-5-2025.pdf)
