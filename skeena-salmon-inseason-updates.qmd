...
tyee.day<-as.Date("2025-10-21")
tyee.date<-"October 21"
figures.x.date<-as.Date("2025-10-21")

fence.day<-as.Date("2025-10-21")
fence.date<-"October 21"

today<-as.Date("2025-10-22")
```
...
-   Pre-season forecasts
    ...
    -   The pre-season forecast for the Total Return of Skeena sockeye in 2025 ranged from 1.3 to 5.8 million (90% confidence range) with a point estimate (p50) of 2.7 million.
...
current<-read.csv("data/current_year/babine fence 2025.csv") %>%
...
p2<-make.recent.cum.plot(sx.cumesc,2500000,as.Date("2025-09-01"))
...
make.trtc.sx.plot(sx.trtc.model,7500000,as.Date("2025-09-30"))
...
[Update to September 2](/data/steelhead/Skeena%20Summer%20Steelhead%20Update%20to%20Sept%202_25.xlsx)

[Update to August 25](/data/steelhead/Skeena%20Summer%20Steelhead%20Update%20to%20Aug%2025_25.xlsx)

[Update to August 18](/data/steelhead/Skeena%20Summer%20Steelhead%20Update%20to%20Aug%2018_25.xlsx)
...
babine.figures.x.high<-as.Date("2025-10-15")
```
...
make.tyee.vs.babine.plot(.1,.97,-500000,1500000,as.Date("2025-06-01"),as.Date("2025-10-01"))
...
[2025 Kitwanga River Salmon Enumeration Update #7](/data/kitwanga/KSEF_Update_7_September%209_2025.pdf)
...
[Update #9-September 2](/data/nc_stad_weekly_updates/NCA%20Weekly%20Update%20#9%20Sept%202%202025.pdf)

[Update #8-August 26](/data/nc_stad_weekly_updates/NCA%20Weekly%20Update%20#8%20Aug%2026%202025%20.pdf)

[Update #7-August 19](/data/nc_stad_weekly_updates/NCA%20Weekly%20Salmon%20Update%20#7.pdf)
...
seinecatch<-read.csv("data/current_year/commercial catch 2025-seine.csv")
gncatch <- read.csv("data/current_year/commercial catch 2025-gillnet.csv")
...
oc2<-allcatch%>%pivot_longer(4:14,names_to="Species",values_to="Catch")%>%
  ...
  filter(Date>as.Date("2025-07-05")&Date<as.Date("2025-08-10"))%>%mutate(dis=ifelse(Species%in%c("Chinook..Released.","Chum..Released.","Steelhead.. Released.","Coho..Released.","Sockeye..Released.","Pink..Released."),"Released","Kept"))%>%
  mutate(sp=case_when(Species=="Chinook..Released."~"Chinook",
