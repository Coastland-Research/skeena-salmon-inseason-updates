...
tyee.day<-as.Date("2025-08-22")
tyee.date<-"August 22"
figures.x.date<-as.Date("2025-09-15")

fence.day<-as.Date("2025-08-22")
fence.date<-"August 22"

today<-as.Date("2025-08-23")
```
...
-   Tyee Test Fishery
    ...
    -   If average run-timing, \~ 96% of the run has passed Tyee to date.
