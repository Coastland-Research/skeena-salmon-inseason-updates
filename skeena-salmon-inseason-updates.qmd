...
-   Tyee Test Fishery
    ...
    -   To date \> 1.7M sockeye are estimated to have passed by Tyee, with very few additional sockeye expected. Daily sockeye counts have dropped and are now very low (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate is around 1.95M with just under 200,000 marine commercial catch between Area C, Area A and First Nations Demo/EO fisheries.
    ...
    -   The Steelhead index suggests a strong run at the beginning of the season, with daily counts diminishing now. The current run is tracking around the 75th percentile of returns. The latest Province of BC update estimates around 33,313 Steelhead through Tyee to date (as of August 29) (Figure 11).
...
-   Babine Jack sockeye
    ...
    -   The total run of jack sockeye to date is now over 112k, well above the longer term and recent averages (Figures 16-17).
...
babine_fence <- read_excel("data/babine data 2024.xlsx", sheet = "Babine")
```
...
![](steelhead_aug29.pdf){width="80%" height="500"}

Previous Tyee steelhead updates can be downloaded here:

[Skeena Summer Steelhead Update to August 15](%22Skeena%20Summer%20Steelhead%20Update%20to%20Aug%20_15_24.xlsx%22)

[Skeena Summer Steelhead Update to August 8](%22Skeena%20Summer%20Steelhead%20Update%20to%20Aug%20_8_24.xlsx%22)
...
There are concerns at the Babine River about high temperatures and low water levels holding up passage of sockeye and other salmon through the fence. In 2024, LBN has implemented the Babine River Collaborative Management Plan and has choosen to voluntarily move their harvest from the Babine fence to Babine Lake.
