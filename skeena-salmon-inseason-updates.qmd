...
tyee.day<-as.Date("2025-10-26")
tyee.date<-"October 26"
figures.x.date<-as.Date("2025-10-26")

fence.day<-as.Date("2025-10-26")
fence.date<-"October 26"

today<-as.Date("2025-10-27")
```
