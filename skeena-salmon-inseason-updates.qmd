...
tyee.day<-as.Date("2025-07-29")
tyee.date<-"July 29"
figures.x.date<-as.Date("2025-08-15")

fence.day<-as.Date("2025-07-29")
fence.date<-"July 29"

today<-as.Date("2025-07-30")
```
...
-   Tyee Test Fishery
    ...
    -   Sockeye escapement estimates are tracking slightly below the median of returns from 1970-2024, with the TRTC model estimate stabilising over the last 2 weeks while decreasing slightly to around 1.7M on average timing (2.5M if one week late, and 1.4M if one week early), but still well below the pre-season forecast for early and average run-timing projections.
