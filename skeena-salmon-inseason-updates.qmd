...
tyee.day<-as.Date("2025-07-06")
tyee.date<-"July 6"
figures.x.date<-as.Date("2025-07-14")

# fence.day<-as.Date("2024-09-22")
# fence.date<-"September 22"

today<-as.Date("2025-07-06")
```
...
make.index.figures(daily,current,25,150,figures.x.date)
...
make.tyee.sockeye.escapement.plots(60000,200000,figures.x.date)
