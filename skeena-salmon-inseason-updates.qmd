...
tyee.day<-as.Date("2025-09-14")
tyee.date<-"September 14"
figures.x.date<-as.Date("2025-09-30")

fence.day<-as.Date("2025-09-14")
fence.date<-"September 14"

today<-as.Date("2025-09-15")
```
