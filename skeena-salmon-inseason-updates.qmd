...
-   Tyee Test Fishery
    ...
    -   Sockeye escapement estimates are tracking right around the median of returns from 1970-2024, with the TRTC model estimate stabilising over the last 2 weeks while decreasing slightly to around 1.5-1.6M on average timing (2.5M if one week late, and 1.14M if one week early), but still well below the pre-season forecast for early and average run-timing projections.
    -   If average run-timing, ~ 55% of the run has passed Tyee to date.
...
p1<-make.recent.esc.plot(sx.daily.recent,figures.x.date)
p2<-make.recent.cum.plot(sx.cumesc,1500000,figures.x.date)
