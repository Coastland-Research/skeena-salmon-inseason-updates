...
com_catch <- read_excel("data/commercial catch 2024.xlsx", sheet = "catch") %>%
...
fn_catch <- read_excel("data/FNs catch 2024.xlsx", sheet = "demo catches")
```

```{r set days, echo=FALSE}
tyee.day<-as.Date("2024-09-12")
tyee.date<-"September 12"
fence.day<-as.Date("2024-09-12")
fence.date<-"September 12"
today<-as.Date("2024-09-12")
```
...
kable(stat5, caption=paste0("Precent of the sockeye run through Tyee to ",tyee.date,"."))
```
