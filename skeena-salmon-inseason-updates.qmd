...
tyee.day<-as.Date("2024-07-24")
tyee.date<-"July 24"
fence.day<-as.Date("2024-07-23")
fence.date<-"July 23"
today<-as.Date("2024-07-24")
```
...
-   Tyee Test Fishery
    ...
    -   To date 1,002,258 sockeye are estimated to have passed by Tyee, with about 49.1% of the run through to date on average (29% if 1-week late, 69% if one week early). Sockeye escapement is not picking up for a large run and is continuing to be variable (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate around 1,037,000 (not including marine food fish and catch from the last few days).

    -   We are at the midpoint of the run on average timing, and gaining more confidence in predicting the final TRTC. The excel model increased in early July stabilized briefly, decreased significantly, and stabilized again, and is now slightly increasing with the last 3 days of large runs. We are now tracking slightly greater than the 2023 run.

    -   The current run size prediction is 2.1M on average run-timing (3.3M if one week late and 1.6M if 1 week early) (Figure 6). The next week will be important towards the peak of the run on avearge run timing, and will tell if we are tracking a 2022, 2023 or a something in between run. We should be seeing daily runs of aroudn 50-100k to keep pace with the 2023 return.
