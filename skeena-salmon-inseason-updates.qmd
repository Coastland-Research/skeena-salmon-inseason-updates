...
tyee.day<-as.Date("2025-08-25")
tyee.date<-"August 25"
figures.x.date<-as.Date("2025-09-15")

fence.day<-as.Date("2025-08-25")
fence.date<-"August 25"

today<-as.Date("2025-08-26")
```
...
<img src="/images/tides12.png" title="Tides at Port Edward" alt="Tides at Port Edward" width="700"/>
