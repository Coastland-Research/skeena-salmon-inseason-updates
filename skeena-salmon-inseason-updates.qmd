...
tyee.day<-as.Date("2024-09-02")
tyee.date<-"September 2"
fence.day<-as.Date("2024-09-02")
fence.date<-"September 2"
today<-as.Date("2024-09-02")
```
...
stat4 <- data.frame(`Run Timing`=c("Average","One week early","One week late"),`Percent Through`=c(avgper,earlyper,lateper))
names(stat4) <- gsub('[.]', ' ', names(stat4))

kable(stat4, caption=paste0("Precent of the sockeye run through Tyee to ",tyee.date,"."))
```
