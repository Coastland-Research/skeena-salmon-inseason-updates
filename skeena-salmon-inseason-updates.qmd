...
tyee.day<-as.Date("2024-07-29")
tyee.date<-"July 29"
fence.day<-as.Date("2024-07-29")
fence.date<-"July 29"
today<-as.Date("2024-07-29")
```
...
-   Tyee Test Fishery
    ...
    -   To date 1,293,658 sockeye are estimated to have passed by Tyee, with about 64% of the run through to date on average (43% if 1-week late, 80% if one week early). While sockeye escapement over the last week picked up considerably, we are now past the peak of the run on average run-timing, Sockeye migration has dropped off over the last couple of days (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate around 1.4M (not including marine food fish and catch from the last few days).
...
-   Commercial Fisheries
    ...
    -   Commercial fishing has started, with an Area C gillnet openings on July 13, 20 and 21, and First Nations demonstration fisheries on July 16. Preliminary sockeye catch in the Area C gillnet openings is \~ 103,000. Preliminary demonstration fishery catches are \~ 10,000 sockeye. More catch information will be added as it becomes available.
...
#| echo: false
#| fig-cap: "Tyee test fishery daily escapement and cumulative escapement by year since 2000 vs 2024 data"
#| warning: false
#| include: true
#| fig-height: 4
