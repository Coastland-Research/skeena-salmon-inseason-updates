...
tyee.day<-as.Date("2024-08-25")
tyee.date<-"August 25"
fence.day<-as.Date("2024-08-25")
fence.date<-"August 25"
today<-as.Date("2024-08-25")
```
...
-   Tyee Test Fishery
    ...
    -   To date > 1.7M sockeye are estimated to have passed by Tyee, with about 97% of the run through to date on average (93% if 1-week late, 99% if one week early). Daily sockeye counts have dropped and are now very low (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate is around 1.95M with about 200,000 marine commercial catch between Area C, Area A and First Nations Demo/EO fisheries.
    ...
    -   The current run size prediction is 1.96M on average run-timing (2M if one week late and 1.9M if 1 week early) (Figure 6). These should not change much anymore through the remainder of the run.
    ...
    -   Pink salmon are looking strong this year relative to even-year abundance with the index tracking betwee the 75th and 90th percentiles (Figure 9).

    -   Coho salmon are passing through Tyee and tracking just under the long term average (Figure 10).

    -   The Steelhead index suggests a strong run is continuing, around the 90th percentile. The latest Province of BC update estimates around 32,088 Steelhead through Tyee to date (as of August 22) (Figure 11).

-   Babine Fence

    -   The Babine River fence started operations on July 9th. The total large sockeye run to date is \~ 1.6M with recent large return days bumping the run over the recent and historical averages, and exceeding 2023 (Figures 12-14).

    -   The total run of jack sockeye to date is now over 87k, well above the longer term and recent averages (Figures 15-16).
...
stat3<-data.frame(`Cumulative to Date`=c("Escapement Past Tyee","Area A Seine Catch", "Area C Gillnet Catch", "First Nations Demo Catch (Marine)", "First Nations Demo Catch (In-River)", "Total First Nations FSC Catch", "TRTC (Escapement+Catch)"),`Number of Sockeye`=c(e,t,c),
