...
tyee.day<-as.Date("2024-08-13")
tyee.date<-"August 13"
fence.day<-as.Date("2024-08-13")
fence.date<-"August 13"
today<-as.Date("2024-08-13")
```
...
-   Tyee Test Fishery
    ...
    -   To date \~1.68M sockeye are estimated to have passed by Tyee, with about 91% of the run through to date on average (82% if 1-week late, 96% if one week early). Daily sockeye counts have dropped and are now under 10,000 (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate is around 1.86M with about 200,000 marine commercial catch between Area C, Area A and First Nations Demo/EO fisheries.
...
-   Babine Fence
    ...
    -   The Babine River fence started operations on July 9th. The total large sockeye run to date is \~ 789k with recent large return days bumping the run over the recent and historical averages, and exceeding 2023 (Figures 12-14).

    -   The total run of jack sockeye to date is now over 48k, well above the longer term and recent averages (Figures 15-16).
