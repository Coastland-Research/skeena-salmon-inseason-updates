...
tyee.day<-as.Date("2024-08-10")
tyee.date<-"August 10"
fence.day<-as.Date("2024-08-10")
fence.date<-"August 10"
today<-as.Date("2024-08-10")
```
...
-   Tyee Test Fishery
    ...
    -   Tides influence the migration of salmon into the Skeena River. We are currently moving towards smaller tides. [(Tides section)](#tide-information-at-port-edward)

    -   To date \~1.66M sockeye are estimated to have passed by Tyee, with about 88% of the run through to date on average (76% if 1-week late, 94% if one week early). Daily sockeye counts are around 30,000 but declining and we are now well past the peak of the run (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate is around 1.86M with about 200,000 marine commercial catch between Area C, Area A and First Nations Demo/EO fisheries.

    -   The excel model increased in early July, stabilized briefly, decreased significantly, and stabilized again, declined slowly, and since has stabilized again. The 3 lines are converging as is normal this time of year and this also supports average timing of the run. A late push of fish could change that however.

    -   The current run size prediction is 2.1M on average run-timing (2.4M if one week late and 2M if 1 week early) (Figure 6). These should not change much anymore through the remainder of the run.
...
-   Commercial Fisheries
    ...
    -   Preliminary sockeye catch in the Area C gillnet openings is \~ 128,000. Preliminary sockeye catch in the Area A seine fisheries is \~ 46,000. Preliminary demonstration fishery catches are likely near 20,000 sockeye.
...
![](Skeena Summer Steelhead Update to Aug _8_24.pdf){width=80% height=500}
...
-   The Kitwanga fence was operational and counting as of 
July 10.
