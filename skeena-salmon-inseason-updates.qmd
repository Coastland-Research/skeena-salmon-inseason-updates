...
tyee.day<-as.Date("2025-06-30")
tyee.date<-"June 30"
figures.x.date<-as.Date("2025-07-10")

# fence.day<-as.Date("2024-09-22")
# fence.date<-"September 22"

today<-as.Date("2025-06-29")
```
...
-   Pre-season forecasts
    ...
    -   The pre-season forecast for the terminal run of Skeena Chinook point estimate is 26,615 and with a 50% confidence interval of 16,683 (p25) to 34,747 (p75).
