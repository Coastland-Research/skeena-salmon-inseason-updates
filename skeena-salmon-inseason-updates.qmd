...
tyee.day<-as.Date("2024-07-15")
tyee.date<-"July 15"
fence.day<-as.Date("2024-07-15")
fence.date<-"July 15"
today<-as.Date("2024-07-15")
```
...
-   We are currently moving towards larger tides again which may influence the migration of salmon into the Skeena River [(Tides section)](#tide-information-at-port-edward)

-   To date 509,398 sockeye are estimated to have passed by Tyee, with about 24.2% of the run through to date on average (11.3% if 1-week late, 43.2% if one week early). Sockeye escapement has picked up over the last week however is continuing to be variable (Figures 1-5).

-   We are getting closer to the mid-point of the run, but at \~25% on average timing, it is still early to make predictions on the final TRTC. The excel model was increasing for all 3 run-timings, however it has since stabilized, and is starting to decrease. The current run size prediction is 2.1M on average run-timing (4M if one week late and 1.25M if 1 week early) (Figure 6). The next week will be important as we move towards larger tides and towards the peak of the run, and will tell if we are tracking a 2022, 2023 or a something in between run.

-   Other salmon species figures are in progress to show the 2024 Tyee daily index in comparison with historical index values.

-   The Babine fence started operations July 9, with 34 large sockeye through. The Babine section of the report will be updated in the next few days, along with the Babine-Tyee comparison.

-   The Kitwanga fence started operations last week, with counts starting as of July 10.

-   Commercial fishing has started, with an Area C gillnet opening on July 13 - catch numbers will be updated as soon as they are available.
