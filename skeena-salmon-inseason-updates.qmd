...
tyee.day<-as.Date("2024-08-12")
tyee.date<-"August 12"
fence.day<-as.Date("2024-08-12")
fence.date<-"August 12"
today<-as.Date("2024-08-12")
```
...
-   Tyee Test Fishery
    ...
    -   To date \~1.68M sockeye are estimated to have passed by Tyee, with about 90% of the run through to date on average (80% if 1-week late, 95% if one week early). Daily sockeye counts have dropped and are now under 10,000 (Figures 1-5). Including commercial catch and First Nations marine catches, the TRTC estimate is around 1.86M with about 200,000 marine commercial catch between Area C, Area A and First Nations Demo/EO fisheries.

    -   The excel model increased in early July, stabilized briefly, decreased significantly, and stabilized again, declined slowly, and since has stabilized again. The 3 lines are converging as is normal this time of year and this also supports average timing of the run.

    -   The current run size prediction is 2.1M on average run-timing (2.3M if one week late and 2M if 1 week early) (Figure 6). These should not change much anymore through the remainder of the run.
...
-   Babine Fence
    ...
    -   The Babine River fence started operations on July 9th. The total large sockeye run to date is \~ 537k with recent large return days bumping the run over the recent and historical averages, and exceeding 2023 (Figures 12-14).

    -   The total run of jack sockeye to date is now over 33,000, well above the longer term and recent averages (Figures 15-16).
...
-   Commercial Fisheries
    ...
    -   Commercial fishing has started, with Area C gillnet openings on July 13, 20-21, 25-26, 29-30, August 2-3 and 8-9. The Area A seine fishery was open July 25-28 and August 2-5. Coastal Demonstration Fisheries opened on July 16, 21, 24, 27-28, July 31-August 2, August 4-7 and 11. In-river demonstration fisheries started July 30.
    
    -   Preliminary sockeye catch in the Area C gillnet openings is \~ 132,000. Preliminary sockeye catch in the Area A seine fisheries is \~ 46,000. Preliminary demonstration fishery catches are likely near 20,000 sockeye. Late timed commercial openings had low effort and low catch rates.
...
[Skeena Summer Steelhead Update to August 1](Skeena Summer Steelhead Update to Aug 1_24.xlsx)

[Skeena Summer Steelhead Update to July 25](Skeena Summer Steelhead Update to July 25_24 (1).xlsx)

[Skeena Summer Steelhead Update to July 17](Skeena Summer Steelhead Update to July 17_24.xlsx)
...
inrivercatch<-read_excel("data/tyee and catch and fence in-season updates 2024.xlsx",sheet="inriver catch") # update this to 2024
