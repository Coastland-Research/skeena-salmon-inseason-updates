...
tyee.day<-as.Date("2025-07-15")
tyee.date<-"July 15"
figures.x.date<-as.Date("2025-08-01")

# fence.day<-as.Date("2024-09-22")
# fence.date<-"September 22"

today<-as.Date("2025-07-16")
```
...
-   Tyee Test Fishery
    ...
    -   Sockeye escapement estimates are tracking right around the median of returns from 1970-2024, with the TRTC model estimate decreasing over the last few days to around 1.7M on average timing (3.7M if one week late, and 872k if one week early), and still well below the pre-season forecast for early and average run-timing projections.
    -   Chinook are also being caught at Tyee, with the cumulative index increasing to between the 25th and 50th percentiles to date. Compared to recent years (2011 on), the Chinook index is looking quite good tracking near the 75th percentile.
    -   Pink salmon have started entering the Skeena, and are tracking near the 90th percentile.
    -   Chum, steelhead, and coho have started showing up at Tyee, with the index remaining low to date.

-   Babine

    -   The Babine fence typically started operations on July 14. This section will be updated shortly.
...
-   Commercial Fisheries
    ...
    -   Commercial fisheries targetting sockeye in Area 4 started on July 12. Catch numbers will be updated as they are available.
    -   First Nations demonstration fisheries targetting sockeye in Area 4 opened on July 9. Catch information will be updated as numbers are available.

-   Recreational Fisheries

    -   Recreational fisheries for sockeye will liekly start shortly since commercial fisheries targetting sockeye have now opened.
...
make.index.figures(daily,current,60,1200,figures.x.date)
...
make.tyee.sockeye.escapement.plots(100000,1500000,figures.x.date)
...
p2<-make.recent.cum.plot(sx.cumesc,500000,as.Date("2025-08-01"))
...
![](North%20Coast%20Salmon%20Update%20July%208%202025.pdf)
