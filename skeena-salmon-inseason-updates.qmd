...
tyee.day<-as.Date("2025-08-16")
tyee.date<-"August 16"
figures.x.date<-as.Date("2025-09-01")

fence.day<-as.Date("2025-08-16")
fence.date<-"August 16"

today<-as.Date("2025-08-17")
```
...
-   Tyee Test Fishery
    ...
    -   Sockeye escapement estimates are tracking just below the median of returns from 1970-2024, with the TRTC model estimate stabilising over the last 2 weeks while decreasing slightly to around 1.67M on average timing (1.96M if one week late, and 1.65M if one week early), but still well below the pre-season forecast for early and average run-timing projections.
    -   If average run-timing, \~ 92% of the run has passed Tyee to date.
