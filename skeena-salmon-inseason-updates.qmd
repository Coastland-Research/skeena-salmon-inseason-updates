...
tyee.day<-as.Date("2024-07-16")
tyee.date<-"July 16"
fence.day<-as.Date("2024-07-16")
fence.date<-"July 16"
today<-as.Date("2024-07-16")
```
...
-   To date 530,085 sockeye are estimated to have passed by Tyee, with about 26.5% of the run through to date on average (12.7% if 1-week late, 46.2% if one week early). Sockeye escapement has picked up over the last week however is continuing to be variable (Figures 1-5).

-   We are getting closer to the mid-point of the run, but at \~25% on average timing, it is still early to make predictions on the final TRTC. The excel model was increasing for all 3 run-timings, however it has since stabilized, and is starting to decrease. The current run size prediction is 2.0M on average run-timing (3.7M if one week late and 1.2M if 1 week early) (Figure 6). The next week will be important as we move towards larger tides and towards the peak of the run, and will tell if we are tracking a 2022, 2023 or a something in between run.
...
-   The Babine fence started operations July 9, with 162 large sockeye through. The Babine section of the report will be updated in the next few days, along with the Babine-Tyee comparison.
