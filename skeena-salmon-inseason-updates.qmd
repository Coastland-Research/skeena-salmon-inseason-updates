...
tyee.day<-as.Date("2025-08-05")
tyee.date<-"August 5"
figures.x.date<-as.Date("2025-09-01")

fence.day<-as.Date("2025-08-05")
fence.date<-"August 5"

today<-as.Date("2025-08-06")
```
...
-   Tyee Test Fishery
    ...
    -   If average run-timing, ~ 76% of the run has passed Tyee to date.
...
[2025 Kitwanga River Salmon Enumeration Update #1](/data/kitwanga/KSEF_Update_1_July29_2025.pdf)
