...
tyee.date<-"July 22"
fence.day<-as.Date("2024-07-22")
fence.date<-"July 22"
today<-as.Date("2024-07-22")
```
...
-   Babine Sockeye
    ...
    -   The Babine River fence started operations on July 9th. To date the total run is 21,800 large sockeye, with 366 jack sockeye to date. More details will be added here shortly along with 2 forecast methods.
