...
The 2025 chum salmon index is shown below and compared to historical index data from the Tyee test fishery (@fig-index-chinook) in the text.
...
The 2025 pink salmon index is shown below and compared to historical index data from the Tyee test fishery (@fig-index-chinook) in the text.
...
The 2025 coho salmon index is shown below and compared to historical index data from the Tyee test fishery (@fig-index-chinook) in the text.
...
The 2025 steelhead index is shown below and compared to historical index data from the Tyee test fishery (@fig-index-chinook) in the text.
