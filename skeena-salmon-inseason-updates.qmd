...
make.index.figures(daily,current,15,50,as.Date("2025-07-02"))
...
make.index.figures(daily,current,15,200,as.Date("2025-07-02"))
```
...
make.index.figures(daily,current,10,50,as.Date("2025-07-02"))
...
make.index.figures(daily,current,5,20,as.Date("2025-07-02"))
```
